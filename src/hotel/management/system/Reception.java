...
public class Reception extends JFrame{
	...
	public Reception(){
                ...
                setBounds(230, 75, 850, 570);
		contentPane = new JPanel();
		setContentPane(contentPane);
		contentPane.setLayout(null);
                
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("hotel/management/system/icons/reception img.jpg"));
                //Image i3 = i1.getImage().getScaledInstance(600, 900,Image.SCALE_DEFAULT);
                //ImageIcon i2 = new ImageIcon(i3);
                JLabel l1 = new JLabel(i1);
                l1.setBounds(250,20,580,520);
                add(l1);
                
                JLabel l2 = new JLabel("RECEPTION");
                l2.setBounds(170,0, 500, 70);
